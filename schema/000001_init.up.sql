...
CREATE USER filter_user WITH ENCRYPTED PASSWORD 'filter_user_031501';
GRANT CONNECT ON DATABASE parsing TO filter_user;
GRANT ALL PRIVILEGES ON TABLE public.filters TO filter_user;
GRANT ALL PRIVILEGES ON TABLE public.kw TO filter_user;
GRANT ALL PRIVILEGES ON TABLE public.categories TO filter_user;
GRANT ALL PRIVILEGES ON TABLE public.search_phrases TO filter_user;
GRANT ALL PRIVILEGES ON TABLE public.kw_lemmas TO filter_user;
GRANT ALL PRIVILEGES ON TABLE public.lemmas TO filter_user;
GRANT ALL ON SEQUENCE public.filters_id_seq TO filter_user;
GRANT ALL ON SEQUENCE public.kw_id_seq TO filter_user;
GRANT ALL ON SEQUENCE public.categories_id_seq TO filter_user;
