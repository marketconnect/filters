...
func (c *filterServiceClient) GetFilterValues(ctx context.Context, in *GetFilterValuesReq, opts ...grpc.CallOption) (*GetFilterValuesResp, error) {
	...
	err := c.cc.Invoke(ctx, FilterService_GetFilterValues_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *filterServiceClient) GetSearchQuery(ctx context.Context, in *GetSearchQueryReq, opts ...grpc.CallOption) (*GetSearchQueryResp, error) {
	...
	err := c.cc.Invoke(ctx, FilterService_GetSearchQuery_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *filterServiceClient) GetLemmasByFilterID(ctx context.Context, in *GetLemmasByFilterIDReq, opts ...grpc.CallOption) (*GetLemmasByFilterIDResp, error) {
	...
	err := c.cc.Invoke(ctx, FilterService_GetLemmasByFilterID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *filterServiceClient) GetKeywordsByLemmas(ctx context.Context, in *GetKeywordsByLemmasReq, opts ...grpc.CallOption) (*GetKeywordsByLemmasResp, error) {
	...
	err := c.cc.Invoke(ctx, FilterService_GetKeywordsByLemmas_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *filterServiceClient) GetKeywordsByWords(ctx context.Context, in *GetKeywordsByWordsReq, opts ...grpc.CallOption) (*GetKeywordsByWordsResp, error) {
	...
	err := c.cc.Invoke(ctx, FilterService_GetKeywordsByWords_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
