...
var file_filter_service_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x32, 0x9c, 0x01, 0x0a, 0x0d, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x53, 0x65, 0x72,
...
var file_filter_service_proto_goTypes = []interface{}{
	...
	(*GetFilterValuesResp)(nil), // 2: main.GetFilterValuesResp
...
var file_filter_service_proto_depIdxs = []int32{
	...
	2, // 2: main.FilterService.GetFilterValues:output_type -> main.GetFilterValuesResp
	3, // 3: main.FilterService.GetSearchQuery:output_type -> main.GetSearchQueryResp
